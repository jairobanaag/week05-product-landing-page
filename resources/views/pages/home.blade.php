<x-layouts.app title="Wake & Brew Coffee Co. - Fresh Coffee, Real Conversations">
    ...
    <section id="features" class="py-16 md:py-24 bg-transparent">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-2xl mx-auto mb-12">
                <span class="text-violet-700 font-semibold text-sm uppercase tracking-wide">Why Wake & Brew</span>
    ...
    <section class="py-16 md:py-24 bg-white/60 backdrop-blur-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-2xl mx-auto mb-12">
                <span class="text-violet-700 font-semibold text-sm uppercase tracking-wide">See It In Action</span>
                <h2 class="text-3xl md:text-4xl font-extrabold text-black mt-2">See Wake & Brew in action</h2>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="rounded-2xl overflow-hidden shadow-lg">
                    <img src="https://placehold.co/500x350/2e1065/ffffff?text=Product+Screenshot" alt="Product screenshot" class="w-full h-full object-cover">
                </div>
                <div class="rounded-2xl overflow-hidden shadow-lg">
                    <img src="https://placehold.co/500x350/6d28d9/ffffff?text=Dashboard+Preview" alt="Dashboard preview" class="w-full h-full object-cover">
                </div>
                <div class="rounded-2xl overflow-hidden shadow-lg">
    ...
    <section id="pricing" class="py-16 md:py-24 bg-transparent">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-2xl mx-auto mb-16">
                <span class="text-violet-700 font-semibold text-sm uppercase tracking-wide">Membership</span>
                <h2 class="text-3xl md:text-4xl font-extrabold text-black mt-2">Choose your brew plan</h2>
    ...
    <section id="testimonials" class="py-16 md:py-24 bg-white/60 backdrop-blur-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-2xl mx-auto mb-12">
                <span class="text-violet-700 font-semibold text-sm uppercase tracking-wide">Testimonials</span>
                <h2 class="text-3xl md:text-4xl font-extrabold text-black mt-2">Loved by our regulars</h2>
            </div>

            <div class="grid md:grid-cols-3 gap-6">
                <x-testimonial-card photo="https://placehold.co/80x80/6d28d9/ffffff?text=A" name="Ana Reyes" position="Freelance Writer">
                    Wake & Brew is my second office. Great coffee, great Wi-Fi, and the staff remembers my order!
                </x-testimonial-card>
                ...
                <x-testimonial-card photo="https://placehold.co/80x80/6d28d9/ffffff?text=J" name="Joyce Cruz" position="Small Business Owner">
    ...
    <section class="py-16 md:py-20 bg-black">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-gray-300 mb-8">Join thousands of coffee lovers who start their day with Wake & Brew.</p>
